#!/bin/bash
# ao22_x4.bash created using makenewvbe on 2008-01-12:19h55 by graham
cell=ao22_x4

cat ../../../alliance/vbe/sxlib100/ao22_x4.vbe | \
../../../alliance/bin/chfield tphh_i0_q 146 | \
../../../alliance/bin/chfield tpll_i0_q 196 | \
...
../../../alliance/bin/chfield tphh_i2_q 136 | \
